...
3. Using **Claude 4.5 Sonnet** to extract structured contact data from all sources (Owners, Team, Emails)
...
|---|---|---|
| `emails` | All emails found (AI + Regex). | `info@company.com` |
| `owner_name` | **[NEW]** Name of Owner/CEO/Founder. | `Jane Doe` |
| `owner_title` | **[NEW]** Title of key person. | `Founder & CEO` |
| `owner_email` | **[NEW]** Personal/Direct email if found. | `jane@company.com` |
| `team_contacts` | **[NEW]** Other team members found. | `[{"name": "Bob", "title": "CMO"}]` |
| `additional_phones` | All phone numbers found. | `+1-555-0199` |
...
4. **Claude Extraction** - **Claude 4.5 Sonnet** extracts structured contacts (Owners, Team) from all gathered content
...
- **Claude 4.5 Sonnet** is required for deep relationship mapping (Owner-Company), though more expensive than Haiku.
...
Active lead database: https://docs.google.com/spreadsheets/d/1KnwGxF_3SKiosU1O64ILqH0KF6jpap1pT4tSUsLX7H0/edit?gid=0#gid=0

Contains: Detailed leads for Marketing Agencies, Roofers, etc. (Maribor/Ljubljana/Austin).
